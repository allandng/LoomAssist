...
export function KanbanBoard({ tasks, timelines, activeTaskId, onActiveTask, onReload }: KanbanBoardProps) {
          ...
          >
            ...
            <div className={styles.cards}>
              {cards.map(task => {
                ...
                const tl = timelines.find(t => t.id === task.event_id) ?? null;
                const tlColor = tl ? tl.color : 'var(--text-dim)';
                return (
                  <div
                    key={task.id}
